// PCH for C:\Program Files (x86)\Vper\UE\UE_4.27\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "C:/Program Files (x86)/Vper/UE/UE_4.27/Engine/Source/Runtime/Engine/Public/EngineSharedPCH.h"
